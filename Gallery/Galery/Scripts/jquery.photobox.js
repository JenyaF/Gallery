...
(function($, doc, win){
    ...
    var Photobox, photobox, options, images=[], imageLinks, activeImage = -1, activeURL, lastActive, activeType, prevImage, nextImage, thumbsStripe, docElm, APControl, changeImage,
        ...
        overlay =   $('<div id="pbOverlay">').append(
                        ...
                        caption = $('<div id="pbCaption">').append(
                            ...
                            captionText = $('<div class="pbCaptionText">').append('<div class="title"></div><div class="counter"></div>'),
    ...
    function captionTextChange(){
        ...
        if (options.title)
        {
            caption.find('.title').html('<a href='+"\"/Home/PictureInform/" + images[activeImage][1]+"\">" + "Details about picture..." + '</a>');//MYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
